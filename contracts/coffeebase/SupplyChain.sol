...
contract SupplyChain {
        ...
        verifyCaller(msg.sender)
    {
        ...
        items[_upc].productID = items[_upc].upc;
    ...
    function buyItem(uint256 _upc)
        ...
        checkValue(_upc)
    {
        // storing the previous owner so we can pay him / her
        address payable prev_owner = payable(items[_upc].ownerID);
        ...
        // sets new current owner, meaning the distributor
        prev_owner = msg.sender;
